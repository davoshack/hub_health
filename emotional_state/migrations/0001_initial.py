...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ListEmotionalStates'
        db.create_table(u'emotional_state_listemotionalstates', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=120)),
        ))
        db.send_create_signal(u'emotional_state', ['ListEmotionalStates'])

        # Adding model 'EmotionalStatesPatient'
        db.create_table(u'emotional_state_emotionalstatespatient', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'emotional_state', ['EmotionalStatesPatient'])


    def backwards(self, orm):
        # Deleting model 'ListEmotionalStates'
        db.delete_table(u'emotional_state_listemotionalstates')

        # Deleting model 'EmotionalStatesPatient'
        db.delete_table(u'emotional_state_emotionalstatespatient')
    ...
    models = {
        ...
        u'emotional_state.emotionalstatespatient': {
            'Meta': {'object_name': 'EmotionalStatesPatient'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'emotional_state.listemotionalstates': {
            'Meta': {'object_name': 'ListEmotionalStates'},
