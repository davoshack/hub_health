...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Hemoglobin'
        db.create_table(u'hemoglobin_hemoglobin', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('percent', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('note', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'hemoglobin', ['Hemoglobin'])


    def backwards(self, orm):
        # Deleting model 'Hemoglobin'
        db.delete_table(u'hemoglobin_hemoglobin')
    ...
    models = {
        ...
        u'hemoglobin.hemoglobin': {
            'Meta': {'object_name': 'Hemoglobin'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'note': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'percent': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
