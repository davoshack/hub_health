...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClinicalSummary'
        db.create_table(u'patient_clinicalsummary', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('summary', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'patient', ['ClinicalSummary'])


    def backwards(self, orm):
        # Deleting model 'ClinicalSummary'
        db.delete_table(u'patient_clinicalsummary')
    ...
    models = {
        ...
        u'patient.clinicalsummary': {
            'Meta': {'object_name': 'ClinicalSummary'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
