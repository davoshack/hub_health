...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BloodType'
        db.create_table(u'glucoday_bloodtype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=120)),
        ))
        db.send_create_signal(u'glucoday', ['BloodType'])

        # Adding model 'MeasurementContext'
        db.create_table(u'glucoday_measurementcontext', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=120)),
        ))
        db.send_create_signal(u'glucoday', ['MeasurementContext'])

        # Adding model 'Glycemia'
        db.create_table(u'glucoday_glycemia', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('measurement', self.gf('django.db.models.fields.SmallIntegerField')()),
            ('measurement_context', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['glucoday.MeasurementContext'])),
            ('blood_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['glucoday.BloodType'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('note', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'glucoday', ['Glycemia'])


    def backwards(self, orm):
        # Deleting model 'BloodType'
        db.delete_table(u'glucoday_bloodtype')

        # Deleting model 'MeasurementContext'
        db.delete_table(u'glucoday_measurementcontext')

        # Deleting model 'Glycemia'
        db.delete_table(u'glucoday_glycemia')
    ...
    models = {
        ...
        u'glucoday.bloodtype': {
            'Meta': {'object_name': 'BloodType'},
            'description': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'glucoday.glycemia': {
            'Meta': {'object_name': 'Glycemia'},
            'blood_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['glucoday.BloodType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'measurement': ('django.db.models.fields.SmallIntegerField', [], {}),
            'measurement_context': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['glucoday.MeasurementContext']"}),
            'note': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        u'glucoday.measurementcontext': {
            'Meta': {'object_name': 'MeasurementContext'},
            'description': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
