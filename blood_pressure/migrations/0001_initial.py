...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'blood_pressure_heartbeat', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=120)),
        ))
        db.send_create_signal(u'blood_pressure', ['HeartBeat'])

        # Adding model 'Pressure'
        db.create_table(u'blood_pressure_pressure', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('systolic', self.gf('django.db.models.fields.SmallIntegerField')()),
            ('diastolic', self.gf('django.db.models.fields.SmallIntegerField')()),
            ('bpm', self.gf('django.db.models.fields.SmallIntegerField')()),
            ('beat_status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blood_pressure.HeartBeat'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('note', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'blood_pressure', ['Pressure'])


    def backwards(self, orm):
        # Deleting model 'HeartBeat'
        db.delete_table(u'blood_pressure_heartbeat')

        # Deleting model 'Pressure'
        db.delete_table(u'blood_pressure_pressure')
    ...
    models = {
        ...
        u'blood_pressure.heartbeat': {
            'Meta': {'object_name': 'HeartBeat'},
            'description': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'blood_pressure.pressure': {
            'Meta': {'object_name': 'Pressure'},
            'beat_status': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['blood_pressure.HeartBeat']"}),
            'bpm': ('django.db.models.fields.SmallIntegerField', [], {}),
            'diastolic': ('django.db.models.fields.SmallIntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'note': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'systolic': ('django.db.models.fields.SmallIntegerField', [], {}),
