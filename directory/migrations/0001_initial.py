...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'directory_contacts', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('to_user', self.gf('django.db.models.fields.IntegerField')()),
            ('state', self.gf('django.db.models.fields.CharField')(default='Pendiente', max_length=100)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('state_share_journal', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'directory', ['Contacts'])


    def backwards(self, orm):
        # Deleting model 'Contacts'
        db.delete_table(u'directory_contacts')
    ...
    models = {
        ...
        u'directory.contacts': {
            'Meta': {'object_name': 'Contacts'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'from_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'state': ('django.db.models.fields.CharField', [], {'default': "'Pendiente'", 'max_length': '100'}),
            'state_share_journal': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'to_user': ('django.db.models.fields.IntegerField', [], {})
        },
