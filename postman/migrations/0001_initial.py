...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'postman_message', (
            ...
            ('recipient', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'received_messages', null=True, to=orm['auth.User'])),
            ...
            ('moderation_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'moderated_messages', null=True, to=orm['auth.User'])),
