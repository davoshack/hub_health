...
class RegistrationManager(models.Manager):
    ...
    def create_inactive_user(self, username, email, password,
                             site, tipo_usuario, first_name, last_name, send_email=True):
        """
        ...
        registration_profile = self.create_profile(new_user, tipo_usuario)
    ...
    def create_profile(self, user, tipo_usuario ):
        """
        ...
        return self.create(user=user,
                           activation_key=activation_key, tipo_usuario=tipo)
